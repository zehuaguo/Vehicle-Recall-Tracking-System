...
include("dbconnection.php");;
 ...
 // $username = $_POST['username'];
  ...
  $stid=OCIParse($con, "SELECT id FROM USER_general WHERE email='$email' AND password='$password'");
...
$email=$_POST['email1'];
   // $password = $_POST['password'];
    $password= $_POST['password1'];
   if($numberofrows > 0){
      $stid1 = OCIParse($con, "SELECT id FROM USER_general WHERE email='$email' AND password='$password'");
